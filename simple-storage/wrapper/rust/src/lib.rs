...
impl ModuleTrait for Module {
    fn get_data(args: ArgsGetData) -> Result<i32, String> {
    ...
    fn set_data(args: ArgsSetData) -> Result<String, String> {
        EthereumModule::call_contract_method(&ethereum_module::ArgsCallContractMethod {
            address: args.address,
